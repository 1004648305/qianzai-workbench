(function () {
  ...
  var ZODIAC_STEMS=['甲','乙','丙','丁','戊','己','庚','辛','壬','癸'];
  var ZODIAC_BRANCHES=['子','丑','寅','卯','辰','巳','午','未','申','酉','戌','亥'];

  function lunarYearDays(y){ var sum=348; var info=LUNAR_INFO[y-1900]; for(var i=0x8000;i>0x8;i>>=1) sum+=(info&i)?1:0; return sum+leapDays(y); }
  ...
  function getZodiacYear(lunarY){
    var idx=(lunarY-4)%12; if(idx<0) idx+=12;
  ...
  function getWeekDayName(d){ var n=d.getDay(); return ['周日','周一','周二','周三','周四','周五','周六'][n]; }
